...
const required = ['index.html', 'styles.css', 'table-templates.css', 'journal-grid.css', 'progress-tracker.css', 'install-app.css', 'table-pills.js', 'journal-grid.js', 'progress-tracker.js', 'install-app.js', 'app.js', 'data.js', 'theme1.js', 'theme2.js', 'theme3.js', 'theme4.js', 'theme5.js', 'theme6.js', 'theme7.js', 'theme8.js', 'theme9.js', 'theme10.js', 'theme11.js', 'theme12.js', 'theme13.js', 'theme14.js', 'theme15.js', 'theme16.js', 'theme17.js', 'theme18.js', 'theme19.js', 'manifest.webmanifest', 'sw.js'];
